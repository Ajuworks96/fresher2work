import { UserRole, UserStatus, ModerationStatus, WorkSampleCategory, SkillLevel, WorkMode, RelocationPreference, AvailabilityOption, WorkType } from '@prisma/client';
...
async function main() {
  ...
  const devikaUser = await prisma.user.upsert({
    ...
    update: { status: UserStatus.ACTIVE, role: UserRole.STUDENT, passwordHash },
    create: {
  ...
  const devikaSkills = [
    { name: 'Figma', level: SkillLevel.ADVANCED, verified: true },
    { name: 'UI/UX Design', level: SkillLevel.ADVANCED, verified: true },
    { name: 'Design Systems', level: SkillLevel.ADVANCED, verified: true },
    { name: 'Wireframing & Prototyping', level: SkillLevel.ADVANCED, verified: true },
    { name: 'Adobe Illustrator', level: SkillLevel.ADVANCED, verified: true },
    { name: 'User Research', level: SkillLevel.INTERMEDIATE, verified: true },
  ];
  ...
  await prisma.workSample.create({
    data: {
      ...
      category: WorkSampleCategory.CAMPAIGN,
  ...
  const kavyaSkills = [
    { name: 'Google Ads (PMax & Search)', level: SkillLevel.ADVANCED, verified: true },
    { name: 'Meta Ads Manager', level: SkillLevel.ADVANCED, verified: true },
    { name: 'Search Engine Optimization (SEO)', level: SkillLevel.ADVANCED, verified: true },
    { name: 'Google Analytics 4 (GA4)', level: SkillLevel.ADVANCED, verified: true },
    { name: 'Conversion Rate Optimization', level: SkillLevel.ADVANCED, verified: true },
    { name: 'Semrush & Keyword Research', level: SkillLevel.ADVANCED, verified: true },
  ];
  ...
  await prisma.careerPreference.create({
    data: {
      ...
      preferredCountries: ['India', 'United Arab Emirates'],
      workModes: [WorkMode.HYBRID, WorkMode.ON_SITE, WorkMode.REMOTE],
  ...
  await prisma.workSample.create({
    data: {
      ...
      category: WorkSampleCategory.CONTENT,
  ...
  await prisma.workSample.create({
    data: {
      ...
      category: WorkSampleCategory.SOCIAL_MEDIA,
  ...
  const adithyaSkills = [
    { name: 'Adobe Premiere Pro', level: SkillLevel.ADVANCED, verified: true },
    { name: 'Adobe After Effects', level: SkillLevel.ADVANCED, verified: true },
    { name: 'DaVinci Resolve (Color Grading)', level: SkillLevel.ADVANCED, verified: true },
    { name: 'Sound Design & Audio Mixing', level: SkillLevel.ADVANCED, verified: true },
    { name: 'Kinetic Typography', level: SkillLevel.ADVANCED, verified: true },
    { name: 'Motion Graphics', level: SkillLevel.ADVANCED, verified: true },
  ];
